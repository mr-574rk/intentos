export const en = {
  ...
  // Step action names
  action_swap: "Swap",
  action_swap_all: "Full Portfolio Swap",
  action_dca_buy: "DCA Buy",
  action_stake: "Stake",
  action_stake_lp: "Stake LP",
  action_leverage_stake: "Leverage Stake",
  action_provide_liquidity: "Provide Liquidity",
  action_lend: "Lend",
  action_leverage_lend: "Leverage Lend",
  action_leverage_long: "Leverage Long",
  action_compound: "Auto-Compound",
  action_yield_farm: "Yield Farm",
  action_split_allocation: "Split Allocation",
  action_transfer: "Transfer",
  action_batch_transfer: "Batch Transfer",
  action_unstake: "Unstake",
  action_claim_rewards: "Claim Rewards",
  action_cabal_deposit: "Cabal Vault Deposit",
};
